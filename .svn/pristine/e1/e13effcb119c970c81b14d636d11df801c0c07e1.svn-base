...
from scheduleloader.parser.pjd import pjd_excelread
from scheduleloader.parser.whl import whl_excelread
from scheduleloader.parser.ytf import ytf_excelread
...
def inspection(filepath):
    try:
        ...
        if "weidong0064@naver.com" in temp[0]:
            return []
        ...
        elif "ckkhjj2@jiaodongferry.com" in temp[0]:
            return pjd_excelread.parser            
        elif "olivia_han@wanhai.com" in temp[0]:
            return whl_excelread.parser
        elif "hyeri915@yantaiferry.com" in temp[0]:
            return ytf_excelread.parser
        elif "eunhye2362@yantaiferry.com" in temp[0]:
            return ytf_excelread.parser
